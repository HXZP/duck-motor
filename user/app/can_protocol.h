...
#define CAN_PROTOCOL_PID_DEBUG_OUTPUT_BASE_ID (0x360u)
#define CAN_PROTOCOL_FOC_TRACE_PART0_BASE_ID   (0x380u)
#define CAN_PROTOCOL_FOC_TRACE_PART1_BASE_ID   (0x3A0u)
#define CAN_PROTOCOL_FOC_TRACE_PART2_BASE_ID   (0x3C0u)
...
typedef enum
{
    ...
    CAN_PROTOCOL_CMD_FOC_TRACE = 0x41,
...
typedef enum
{
    ...
    CAN_PROTOCOL_FOC_CONFIG_AS5600_BOOT_CONF = 0x05,
    CAN_PROTOCOL_FOC_CONFIG_AS5600_ACTIVE_CONF = 0x06,
    CAN_PROTOCOL_FOC_CONFIG_AS5600_READ_LAST_US = 0x07,
    CAN_PROTOCOL_FOC_CONFIG_AS5600_READ_MIN_US = 0x08,
    CAN_PROTOCOL_FOC_CONFIG_AS5600_READ_MAX_US = 0x09,
    CAN_PROTOCOL_FOC_CONFIG_AS5600_READ_AVERAGE_US = 0x0A
